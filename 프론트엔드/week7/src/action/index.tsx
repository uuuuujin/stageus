...
// 길이가 16인 배열
export const changeNumbers = (lst: any[]) => ({
    type : CHANGE_NUMBERS,
    numberList : lst
})
...
// '게임시작', '정답입니다' 메시지
export const message = (msg: any):object => ({
    type: MESSAGE,
    content : msg
});
...
export const resetBtn = (bool: boolean):object => ({
    type: RESETBTN,
    boolean : bool
});

export const startBtn = (bool: boolean):object => ({
    type: STARTBTN,
    boolean : bool
});
